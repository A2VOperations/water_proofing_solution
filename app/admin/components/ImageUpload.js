...
export default function ImageUpload({ onUploadSuccess, folder = "waterproofing", initialImage = null }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="relative w-full h-48 sm:h-56 bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center overflow-hidden group hover:border-[#0088ff] transition-colors cursor-pointer">
      ...
      {preview && !uploading && (
        <p className="text-[10px] font-bold text-green-500 uppercase tracking-widest text-center">Image Ready</p>
      )}
    </div>
  );
}
