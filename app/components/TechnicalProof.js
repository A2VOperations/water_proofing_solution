        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-10">
          <div>
            ...
            <p className="text-gray-600 text-lg mb-10 leading-relaxed">
              We don&apos;t just paint surfaces; we engineer multi-layer
              protection systems. Each layer serves a specific structural
              purpose to ensure a 100% watertight result.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Mechanical grinding and cleaning for maximum bond.",
                },
                {
                  step: "02",
                  title: "Primer Application",
                  desc: "Deep penetrating sealer to stabilize the surface.",
                },
                {
                  step: "03",
                  title: "Liquid Membrane",
                  desc: "Highly elastic, seamless waterproofing barrier.",
                },
                {
                  step: "04",
                  title: "UV Topcoat",
                  desc: "Weather-resistant finish for long-term durability.",
                },
              ].map((item) => (
                <div key={item.step} className="flex gap-6 items-start">
                  <span className="text-[#0088ff] font-black text-2xl opacity-20">
                    {item.step}
                  </span>
                  <div>
                    <h4 className="font-bold text-[#111] uppercase tracking-tight">
                      {item.title}
                    </h4>
        ...
        <div className="mt-15 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="relative group overflow-hidden rounded-[32px] h-[400px]">
            ...
            <div className="absolute inset-0 bg-linear-to-t from-black/80 via-transparent to-transparent flex items-end p-10">
              <div>
                <span className="bg-[#0088ff] text-white px-4 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest mb-4 inline-block">
                  ON-SITE AUDIT
                </span>
