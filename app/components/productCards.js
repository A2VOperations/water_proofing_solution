      ...
      {loading ? (
        ...
        <div className="relative w-full pb-12">
          ...
          <div className="flex justify-end gap-3 mb-6 pr-2">
            <button className="solutions-prev w-11 h-11 rounded-full bg-white shadow-lg flex items-center justify-center text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed">
            ...
            <button className="solutions-next w-11 h-11 rounded-full bg-white shadow-lg flex items-center justify-center text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed">
