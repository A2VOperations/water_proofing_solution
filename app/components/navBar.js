  ...
  const CATEGORIES = [
    {
      ...
      desc: "Complete waterproofing for every home surface",
      accent: "#0088ff",
    },
    {
      name: "Specialized Solutions",
      desc: "Advanced protection for unique structures",
      accent: "#f97316",
    },
    {
      name: "Technical Solutions",
      desc: "Engineering-grade diagnostics & repairs",
      accent: "#3b82f6",
    },
    {
      name: "Premium Finishes",
      desc: "High-performance decorative coatings",
      accent: "#8b5cf6",
    },
  ];
        ...
        >
          <div className="px-2 flex items-center justify-between h-18">
            ...
            <Link
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = "#006fd6")
              }
              onMouseLeave={(e) =>
            ...
            >
              <span
                className={`block w-6 h-0.5 transition-all duration-300 origin-center ${menuOpen ? "rotate-45 translate-y-2" : ""} ${scrolled || !isTransparentPage ? "bg-gray-800" : "bg-white"}`}
              />
              <span
                className={`block w-6 h-0.5 transition-all duration-300 ${menuOpen ? "opacity-0 scale-x-0" : ""} ${scrolled || !isTransparentPage ? "bg-gray-800" : "bg-white"}`}
              />
              <span
                className={`block w-6 h-0.5 transition-all duration-300 origin-center ${menuOpen ? "-rotate-45 -translate-y-2" : ""} ${scrolled || !isTransparentPage ? "bg-gray-800" : "bg-white"}`}
              />
        ...
        >
          <div className="mt-2 bg-white rounded-2xl shadow-[0_32px_80px_rgba(0,0,0,0.18)] border border-gray-100 overflow-hidden">
            ...
            <div
              ...
              style={{
                background: `linear-gradient(90deg, ${currentAccent}, ${currentAccent}88)`,
              }}
            />
            ...
            <div className="border-t border-gray-100 px-8 py-4 flex items-center justify-between bg-gray-50/60">
              <div className="flex items-center gap-3">
                ...
                <p className="text-gray-500" style={{ fontSize: "13px" }}>
                  ...
                  across {dynamicMegaMenu.length} categories · Available 24/7
                </p>
              </div>
              <div className="flex items-center gap-6">
                ...
                <Link
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = "#006fd6")
                  }
                  onMouseLeave={(e) =>
                ...
                <div key={link.label}>
                  <button
                    ...
                    style={{
                      fontSize: "11px",
                      backgroundColor:
                        isServicesActive || mobileMegaOpen
                          ? "#e8f4ff"
                          : "transparent",
                      color:
                        isServicesActive || mobileMegaOpen
                    ...
                    <div className="pl-1 pt-1 pb-2 flex flex-col gap-3">
                      {dynamicMegaMenu.length > 0 ? (
                        dynamicMegaMenu.map((col, colIdx) => (
                          <div
                            key={col.category}
                            className="border-l-2 border-gray-50 pl-3"
                          >
                            <div className="flex items-center gap-2 py-1.5">
                              ...
                              />
                              <p
                                className="font-black tracking-[0.2em] text-gray-400 uppercase"
                                style={{ fontSize: "9px" }}
                              >
                                {col.category}
                              </p>
                        ...
                        <div className="px-4 py-8 text-center bg-gray-50 rounded-xl">
                          ...
                          <Link
                            href="/contact"
                            className="text-[#0088ff] text-[10px] font-black uppercase tracking-widest mt-2 inline-block"
                          >
                            Contact Us for Info
                          </Link>
                        </div>
