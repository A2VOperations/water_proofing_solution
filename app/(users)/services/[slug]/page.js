                        ...
                        <div className="bg-white rounded-[64px] p-8 md:p-20 shadow-[0_32px_120px_rgba(0,0,0,0.06)] border border-gray-100/50">
                            ...
                            <section className="mb-12 relative">
                                ...
                                <div className="relative">
                                    ...
                                    {/* Mobile Only: Image Slideshow and WhatsApp Button */}
                                    <div className="block lg:hidden mb-12 space-y-8">
                                        {service.photos?.length > 0 && (
                                            <div className="rounded-[32px] overflow-hidden shadow-2xl shadow-black/10 border border-gray-100">
                                                <Swiper
                                        ...
                                        <button 
                                            ...
                                            className="w-full bg-[#25D366] hover:bg-[#1ebd5b] text-white py-5 rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-xl shadow-[#25D366]/20 flex items-center justify-center gap-3 active:scale-95"
                                        >
                                    ...
                                    <div className={`relative transition-all duration-700 ease-in-out ${!isExpanded ? 'max-h-[175px] overflow-hidden' : 'max-h-[5000px]'}`}>
                                        <div 
                                        ...
                                        {!isExpanded && (
                                            <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-white via-white/90 to-transparent z-10" />
                                        )}
                                    </div>
                                    ...
                                    <div className="mt-4 flex justify-center md:justify-start">
                                        <button 
                                            ...
                                            className="group flex items-center gap-4 bg-white border border-gray-200 text-[#0088ff] px-8 py-4 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] transition-all hover:border-[#0088ff] hover:shadow-lg active:scale-95"
                                        >
                                            {isExpanded ? 'Read Less' : 'Read Full Description'}
                                            <div className={`p-1 rounded-full bg-[#0088ff]/10 text-[#0088ff] transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
                                                <svg 
