...
const CONTACT_EMAIL =
  process.env.NEXT_PUBLIC_CONTACT_EMAIL || CONTACT_CONFIG.email;
const CONTACT_ADDRESS =
  process.env.NEXT_PUBLIC_CONTACT_ADDRESS || CONTACT_CONFIG.address;
...
const FAQS = [
  {
    ...
    answer:
      "We recommend a professional dampness audit every 2-3 years, especially before the monsoon season, to identify early signs of structural moisture.",
  },
  {
    question: "Do you offer emergency leak detection?",
    answer:
      "Yes, we provide 24/7 emergency leak detection services across major cities using thermal imaging and moisture meters.",
  },
  {
    question: "What is the standard warranty on waterproofing?",
    answer:
      "Our services come with a performance warranty ranging from 5 to 10 years, depending on the system and material used.",
  },
  {
    question: "How can I request an on-site inspection?",
    answer:
      "You can book a free on-site assessment through our WhatsApp hotline or by filling out the contact form on this page.",
  },
  {
    question: "Do you provide terrace waterproofing installation?",
    answer:
      "Yes, we provide full-service waterproofing for all types of structures using modern membrane and engineering-grade liquid systems.",
  },
];
...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen bg-white font-sans pt-12 pb-24 text-gray-900 relative">
      ...
      {popup && (
        <div
          className={`fixed top-24 left-1/2 -translate-x-1/2 z-50 px-8 py-4 rounded-xl shadow-2xl text-white font-bold transition-all duration-300 transform translate-y-0 opacity-100 flex items-center gap-3 ${popup.type === "error" ? "bg-red-500" : "bg-[#0088ff]"}`}
        >
          {popup.type === "error" ? (
            <svg
              width="24"
      ...
      <section className="max-w-4xl mx-auto px-6 text-center mb-20 mt-20">
        ...
        <p className="text-gray-600 text-lg md:text-xl font-medium max-w-2xl mx-auto">
          Don&apos;t wait for the damage to spread. Get a technical leak report
          and professional dampness audit today.
        </p>
      </section>
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-[15px]">
                    General Inquiries:{" "}
                    <span className="text-[#0088ff]">
                      {adminDetails?.email || CONTACT_EMAIL}
                    </span>
                  </p>
                  <p className="text-gray-600 text-[15px]">
                    Support:{" "}
                    <span className="text-[#0088ff]">
                      {adminDetails?.email || "armannijum@gmail.com"}
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-gray-100 flex items-center gap-6">
                <Image
                  width={96}
                  height={96}
                  src="/assets/industry/warranty_seal.png"
                  alt="10 Year Warranty"
                  className="w-24 h-24 object-contain"
                />
                <div>
                  <h4 className="text-lg font-bold text-gray-900 mb-1 uppercase tracking-tight">
                    10 YEAR WARRANTY
                  </h4>
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Scientific waterproofing backed by our comprehensive
      ...
      <section className="max-w-3xl mx-auto px-6 mb-24">
        <div className="text-center mb-14">
          <h2 className="text-5xl md:text-[64px] font-black uppercase text-[#111] mb-2 tracking-tight">
            FAQ&apos;S
          </h2>
          <p className="text-gray-600 font-medium text-lg">
            Waterproofing solutions questions and answers
          </p>
        </div>
        ...
        <div className="flex flex-col border-t border-gray-200">
          {FAQS.map((faq, index) => (
            ...
            >
              <div className="w-full flex items-center justify-between text-left group cursor-pointer">
                <h3
                  className={`text-xl md:text-[22px] font-bold pr-8 transition-colors ${openFaq === index ? "text-[#0088ff]" : "text-[#111] group-hover:text-[#0088ff]"}`}
                >
                  {faq.question}
                </h3>
                <div
