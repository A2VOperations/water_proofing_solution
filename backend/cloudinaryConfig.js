...
cloudinary.config({
  cloud_name: process.env.CLOUDINARY_CLOUD_NAME || 'diltujyol',
  api_key: process.env.CLOUDINARY_API_KEY || "564887636288762",
  api_secret: process.env.CLOUDINARY_API_SECRET || "ERrrutYnvLiiSLQMyy96roEOKBQ",
});
